...
export class MyApp {
  ...
  constructor(public platform: Platform, public statusBar: StatusBar, public splashScreen: SplashScreen, public awri:AwriConnectProvider) {
    this.initializeApp();
    ...
    this.pages = [
      ...
      { title: 'Einstellungen', component: SettingsPage,isActive:false,icon:'cog'  },
    ];
  }   
